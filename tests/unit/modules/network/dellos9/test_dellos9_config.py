...
from ansible_collections.dell.os9.tests.unit.compat.mock import patch
from ansible_collections.dell.os9.plugins.modules import dellos9_config
from ansible_collections.dell.os9.tests.unit.modules.utils import set_module_args
...
class TestDellos9ConfigModule(TestDellos9Module):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('ansible_collections.dell.os9.plugins.modules.dellos9_config.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_load_config = patch('ansible_collections.dell.os9.plugins.modules.dellos9_config.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_run_commands = patch('ansible_collections.dell.os9.plugins.modules.dellos9_config.run_commands')
